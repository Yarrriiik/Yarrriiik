...
- practical ML systems with measurable results;
- backend services with clear domain logic;
- automation and tooling that reduce manual work;
- clean project presentation for GitHub and portfolio use.

## Background

Student in software engineering, building toward Python Backend, ML Engineering, and automation development.
